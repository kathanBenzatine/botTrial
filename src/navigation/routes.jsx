...
export const routes = [
  ...
  { path: '/', Component: Demo },
  { path: '/IndexPage', Component: Demo },
  { path: '/init-data', Component: Demo, title: 'Init Data' },
  { path: '/theme-params', Component: IndexPage, title: 'Theme Params' },
  { path: '/launch-params', Component: IndexPage, title: 'Launch Params' },
  {
    path: '/ton-connect',
